...
<body>
    <div id="page">
        ...
        <section class="image-head-wrapper" style="background-image: url('images/legendsBanner.png');">
        </section>
        ...
        <section class="contact-block">
            <div class="container">
                <div class="col-md-6 contact-left-block">
                    <p class="text-justify">League of Legends fans! Every Thursday, join us for our weekly League Community Night! Whether your a
                        platinum ranked hero, an ARAM superstar or anything in between, Thursday nights at Belong is for
                        you! Featuring a mix of competitive and fun game modes, there's something for every League of Legends
                        player on Thursday at Belong! </p>
                    </br>
                ...
                <div class="col-md-6 contact-form">
                    <img src="images/legendsInfo.png" class="media-object">
                </div>
                <div class="clearfix"></div>
            </div>
        </section>
