...
<body>
    <div id="page">
        ...
        <section class="image-head-wrapper" style="background-image: url('images/codBanner.png');">
        </section>
        ...
        <section class="contact-block">
            <div class="container">
                <div class="col-md-6 contact-left-block">
                    <p class="text-justify">Tuesday evening in Belong is all about Call of Duty: WWII. Whether you want to play with with some of
                        the best players from across the UK in competitive scrims or simply play with friends both old and
                        new, Tuesday is the perfect time for the Call of Duty fanatic! </p>
                    </br>
                ...
                <div class="col-md-6 contact-form">
                    <img src="images/codInfo.png" class="media-object">
                </div>
                <div class="clearfix"></div>
            </div>
        </section>
