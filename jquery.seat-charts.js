							...
							return function (e) {
								...
								switch (e.which) {
									...
									case 38:
										 ...
										 * 
										 * Using immediate function because we want a convenient access to some DOM elements
										 * Using recursion because sometimes we may hit an empty space rather than a seat.
										 *
										 */
										$newSeat = (function findAvailable($rows, $seats, $currentRow) {
											var $newRow;

											//Determine which row should we move to
											...
											//Get the seat using the current column position
											$newSeat = $newRow.find('.seatCharts-seat,.seatCharts-space').eq($seats.index($seat));

											//if the seat found is a space, keep looking further
										...
										//Couldn't determine the new seat
										if (!$newSeat.length) {
											return;
										}
										...
										//update "aria" reference with the new seat id
