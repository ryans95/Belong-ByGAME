            ...
            <div class="contact_detail">
              <ul>
                <li>
                  ...
                  <div class="contact_info_m">Unit 16, Rushmere Shopping Centre, Craigavon BT64 1AA</div>
                </li>
                <li>
                  <div class="icon_wrap">
                    <i class="fa fa-phone" aria-hidden="true"></i>
                  </div>
                  <div class="contact_info_m">020 8827 0099</div>
                </li>
                <li>
                  <div class="icon_wrap">
                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                  </div>
                  <div class="contact_info_m">gameBelong@gmail.com</div>
                </li>
              </ul>
            </div>
          </div>
