...
<body>
    <div id="page">
        ...
        <section class="image-head-wrapper" style="background-image: url('images/overwatchBanner.png');">
        </section>
        ...
        <section class="contact-block">
            <div class="container">
                <div class="col-md-6 contact-left-block">
                    <p class="text-justify">The world could always use more heroes, and every Wednesday is your chance to be a part of it! Head down
                        to any of our Belong Arenas each Wednesday to play with other Overwatch fans across a serious of
                        competitive and fun game modes. There's always games to play with other Overwatch fans! </p>
                    </br>
                ...
                <div class="col-md-6 contact-form">
                    <img src="images/overwatchInfo.png" class="media-object">
                </div>
                <div class="clearfix"></div>
            </div>
        </section>
